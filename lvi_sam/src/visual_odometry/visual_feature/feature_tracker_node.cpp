...
//         RCLCPP_WARN(rclcpp::get_logger("rclcpp"),"image discontinue! reset the feature tracker!");
...
//         ptr = cv_bridge::toCvCopy(img,"mono8");
//     }
//     else
...
//         RCLCPP_DEBUG(rclcpp::get_logger("rclcpp"),"processing camera %d", i);
//         if (i != 1 || !STEREO_TRACK)
...
//    {
//         pub_count++;
//         sensor_msgs::msg::PointCloud::Ptr feature_points(new sensor_msgs::msg::PointCloud);
...
//             ptr = cv_bridge::cvtColor(ptr,"rgb8");
...
//     //ros::NodeHandle n;
//     std::shared_ptr<rclcpp::Node> Feature_Tracker_Node_obj = std::make_shared<rclcpp::Node>("vins");

//     //ROS_INFO("\033[1;32m----> Visual Feature Tracker Started.\033[0m");
//     RCLCPP_INFO(rclcpp::get_logger("rclcpp"),"\033[1;32m----> Visual Feature Tracker Started.\033[0m");

//     //ros::console::set_logger_level(ROSCONSOLE_DEFAULT_NAME, ros::console::levels::Warn);

//     readParameters(Feature_Tracker_Node_obj);
...
//     depthRegister = new DepthRegister(Feature_Tracker_Node_obj);
...
//     sub_img     = Feature_Tracker_Node_obj->create_subscription<sensor_msgs::msg::Image>(IMAGE_TOPIC,5,img_callback);
//     sub_lidar   = Feature_Tracker_Node_obj->create_subscription<sensor_msgs::msg::PointCloud2>(POINT_CLOUD_TOPIC,5,lidar_callback);
...
//     pub_feature = Feature_Tracker_Node_obj->create_publisher<sensor_msgs::msg::PointCloud>(PROJECT_NAME + "/vins/feature/feature",5);
//     pub_match   = Feature_Tracker_Node_obj->create_publisher<sensor_msgs::msg::Image>(PROJECT_NAME + "/vins/feature/feature_img", 5);
//     pub_restart = Feature_Tracker_Node_obj->create_publisher<std_msgs::msg::Bool>(PROJECT_NAME + "/vins/feature/restart",5);
...
class Feature_Tracker_Node : public DepthRegister , public rclcpp::Node
{
    public:

        Feature_Tracker_Node() : Node("vins")
        {
            ...
            depthRegister = new DepthRegister(this);

            sub_img     = this->create_subscription<sensor_msgs::msg::Image>(IMAGE_TOPIC,5,std::bind(&Feature_Tracker_Node::img_callback,this,std::placeholders::_1));
            sub_lidar   = this->create_subscription<sensor_msgs::msg::PointCloud2>(POINT_CLOUD_TOPIC,5,std::bind(&Feature_Tracker_Node::lidar_callback,this,std::placeholders::_1));
    ...
    private:
        ...
        void lidar_callback(const sensor_msgs::msg::PointCloud2::SharedPtr laser_msg)
        {
            ...
            rollCur  = transform.transform.rotation.x;
            pitchCur = transform.transform.rotation.y;
            yawCur   = transform.transform.rotation.z;
...
int main(int argc , char **argv)
{
    ...
    rclcpp::executors::MultiThreadedExecutor FT_Exec;

    auto FT = std::make_shared<Feature_Tracker_Node>();
    FT_Exec.add_node(FT);
