...
class IMUPreintegration : public ParamServer
{
    ...
    public:
        ...
        {
            subImu = create_subscription<sensor_msgs::msg::Imu>(imuTopic, 2000,std::bind(&IMUPreintegration::imuHandler, this,std::placeholders::_1));
            subOdometry = create_subscription<nav_msgs::msg::Odometry>(PROJECT_NAME + "/lidar/mapping/odometry", 5,std::bind(&IMUPreintegration::odometryHandler, this,std::placeholders::_1));

            pubImuOdometry = create_publisher<nav_msgs::msg::Odometry>("odometry/imu", 2000);
            pubImuPath = create_publisher<nav_msgs::msg::Path>(PROJECT_NAME + "/lidar/imu/path", 1);

            tf2::Quaternion q;
            q.setRPY(0,0,0);
            map_to_odom = tf2::Transform(q,tf2::Vector3(0,0,0));
        ...
        bool failureDetection(const gtsam::Vector3& velCur, const gtsam::imuBias::ConstantBias& biasCur)
        {
            ...
            if (vel.norm() > 30)
            {
                RCLCPP_WARN(rclcpp::get_logger("rclcpp"),"Large velocity, reset IMU-preintegration!");
                return true;
            }
            ...
            {
                RCLCPP_WARN(rclcpp::get_logger("rclcpp"),"Large bias, reset IMU-preintegration!");
                return true;
            }
        ...
        void imuHandler(const sensor_msgs::msg::Imu::SharedPtr imuMsg)
        {
            ...
            tf2::TimePoint tfMap2Odom_TimeStamp = tf2_ros::fromRclcpp(thisImu.header.stamp);
            tf2::Stamped<tf2::Transform> temp_tfMap2Odom(map_to_odom,tfMap2Odom_TimeStamp,"map");
            geometry_msgs::msg::TransformStamped tfMap2Odom_Stamped;
            tf2::convert(temp_tfMap2Odom,tfMap2Odom_Stamped);
            tfMap2Odom_Stamped.child_frame_id = "odom";
            tfMap2Odom->sendTransform(tfMap2Odom_Stamped);
            ...
            tf2::TimePoint tCur_TimeStamp = tf2_ros::fromRclcpp(thisImu.header.stamp);
            tf2::Stamped<tf2::Transform>temp_tCur(tCur,tCur_TimeStamp,"odom");
            geometry_msgs::msg::TransformStamped odom_2_baselink;
            tf2::convert(temp_tCur,odom_2_baselink);
...
int main(int argc , char **argv)
{
    ...
    auto IP = std::make_shared<IMUPreintegration>(options);
    e.add_node(IP);

    RCLCPP_INFO(rclcpp::get_logger("rclcpp"),"\033[1;32m----> Lidar IMU Preintegration Started.\033[0m");
