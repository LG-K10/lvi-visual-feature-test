...
class FeatureExtraction : public ParamServer
{
    public:
        ...
        FeatureExtraction(const rclcpp::NodeOptions & options) : ParamServer("lvi_sam_featureExtraction" , options)
        {
            subLaserCloudInfo = create_subscription<lvi_sam::msg::CloudInfo>(PROJECT_NAME + "/lidar/deskew/cloud_info",
                                                                            5,std::bind(&FeatureExtraction::laserCloudInfoHandler,this,std::placeholders::_1));
            
            pubLaserCloudInfo = create_publisher<lvi_sam::msg::CloudInfo>(PROJECT_NAME + "/lidar/feature/cloud_info", 5);
            pubCornerPoints   = create_publisher<sensor_msgs::msg::PointCloud2>(PROJECT_NAME + "/lidar/feature/cloud_corner", 5);
            pubSurfacePoints  = create_publisher<sensor_msgs::msg::PointCloud2>(PROJECT_NAME + "/lidar/feature/cloud_surface", 5);
...
int main(int argc , char** argv)
{
    ...
    std::cout<<"after shared pointer" << endl;

    exec.add_node(FE);

    RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "\033[1;32m----> Lidar Feature Extraction Started.\033[0m");
    std::cout<<"featureextraction"<<endl;                                     
